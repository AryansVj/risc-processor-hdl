...
HD_PWD='E:/Projects/Risc_v_processor_buildup/risc-processor-hdl/Processor_source/Processor_source.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log processorTOP_risc0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source processorTOP_risc0.tcl -notrace
