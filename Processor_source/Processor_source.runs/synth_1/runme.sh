...
HD_PWD='E:/Projects/Risc_v_processor_buildup/risc-processor-hdl/Processor_source/Processor_source.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log processorTOP_risc0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source processorTOP_risc0.tcl
